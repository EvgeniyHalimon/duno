...
export type TitleAction =
  ...
  | ITitleReview
  | ITitleCleanUpGenres
  | ITitleCleanUpRandomTitles
  | ITitleCleanUpPaginatedTitles
  | ITitleCleanUpSearchResult
  | ITitleCleanUpTitleByGenre
  | ITitleCleanUpCurrentTitle
  | ITitleCleanUpPopularTitle
  | ITitleCleanUpTitleReviews;
