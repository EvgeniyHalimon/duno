...
export const Genres = () => {
  ...
  const uniqueGenres = titleGenres?.reduce(
    (accumulator: Record<number, IGenreData>, genre: IGenreData) => {
  ...
  const sortedGenres = Object.values(uniqueGenres).sort(
    (a: IGenreData, b: IGenreData) => {
